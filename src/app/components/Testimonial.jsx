...
export default function Testimonial() {
  return (
    <div
      id="testimonial"
      className="container py-10 bg-white dark:bg-slate-700 dark:text-white/80 scroll-mt-20"
    >
      <section className="wrapper">
        <h2 className="text-3xl font-lato text-center">
          <span className="font-grand-hotel text-4xl font-medium">
            They are realizing their goals,
          </span>{" "}
          You can as well!{" "}
        </h2>
