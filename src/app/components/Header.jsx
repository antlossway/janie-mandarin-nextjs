  ...
  return (
    ...
    // height of header is around 80px
        <header className='container bg-white sticky top-0 z-10 h-20 '>
            ...
            <section id="mobile-menu" className={showMobileMenu ? "absolute z-10 top-0 right-0 w-full bg-black/50 backdrop-blur-sm  text-white text-4xl flex flex-col justify-center origin-top animate-open-menu"
            : 'hidden' }
                onClick={toggleMobileMenu}>
                {/* close button */}
